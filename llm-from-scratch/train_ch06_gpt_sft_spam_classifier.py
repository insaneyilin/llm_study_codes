...
class LightningGPT2SpamClassifier(pl.LightningModule):
...
def train_gpt():
    ...
    # Make last transformer block and final norm trainable
    ...
    model = LightningGPT2SpamClassifier(model, tokenizer, TRAIN_CFG)

    exp_name = f"gpt2-sft-spam-classifier-avg_embed_{TRAIN_CFG['use_average_embeddings']}"
